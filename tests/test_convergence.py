...
Unit tests for plan v2 §5.3's convergence criterion (improvement below 1%
...
def test_converges_when_plateaued():
    ...
    # 2.0 -> 1.99 (0.5% improvement) -> 1.98 (0.5%) -> 1.97 (0.5%): all below 1%
...
def test_does_not_converge_with_large_improvement():
    ...
    # A sequence that keeps improving by a large margin must not be judged
    # as converged
...
def test_insufficient_history_never_converges():
    ...
    # has not yet reached patience_rounds(3)
